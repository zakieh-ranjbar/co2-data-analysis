...
این مجموعه‌داده شامل ۵۰۰ رکورد است و هیچ مقدار گمشده‌ای ندارد. از آنجا که واحد اندازه‌گیری ستون‌ها در فایل داده مشخص نشده است، مقادیر با همان مقیاس ثبت‌شده در فایل بررسی می‌شوند.
...
ماتریس همبستگی بین ویژگی‌ها و `out1` در فایل `outputs/summary.json` ذخیره شده است. این شاخص میزان رابطهٔ خطی بین متغیرها را نشان می‌دهد و به‌تنهایی به معنی رابطهٔ علت و معلولی نیست.
